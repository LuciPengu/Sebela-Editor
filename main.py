...
def image(data_image):
    ...
    with mp_face_mesh.FaceMesh(static_image_mode=True, max_num_faces=1, refine_landmarks=True, min_detection_confidence=0.5) as face_mesh:
        ...
        upperLipMask, upperglossMap = createBox(imgOriginal, upperlipPoints, 3, masked=True, cropped=False)
        lowerLipMask, lowerglossMap = createBox(imgOriginal, lowerlipPoints, 3, masked=True, cropped=False)
